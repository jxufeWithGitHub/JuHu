! function (e, t) {
  ...
  return function (e) {
    ...
    e.exports = class {
      ...
      init() {
        this.queryData = {}, this.location = {}, this.andData = {}, this.orData = {}, this.limitNum = 100, this.skipNum = 0, this.includes = "", this.queryReilation = {}, this.orders = null, this.keys = null
      }
      get(e) {
      ...
      save(e = {}) {
        ...
        const r = Object.assign(e, this.setData, this.addArray);
    ...
    (function (t) {
      ...
      r.GeoPoint = v, r.generateCode = p, r.sendMessage = f, r.getAccessToken = h, r.sendWeAppMessage = d, r.refund = m, r.notifyMsg = w, r.requestSmsCode = x, r.verifySmsCode = _, r.functions = g, r.timestamp = y, r.requestPasswordReset = b, r.resetPasswordBySmsCode = S, r.updateUserPassword = E, r.push = T, r.Pay = new u, r.User = new a, r.Socket = l, r.Query = (e => new i(e)), r.File = ((e, t) => new c(e, t)), r.request = n(4), r.type = r.utils.getAppType(), r.Pointer = (e => new o(e)), r.Relation = (e => new s(e)), "wx" === r.type ? wx.Bmob = r : "h5" === r.type ? window.Bmob = r : "hap" === r.type ? t.Bmob = r : "nodejs" === r.type && (t.Bmob = r), e.exports = r
    }).call(t, n(6))
  }, function (e, t, n) {
    ...
    const {
      ...
      save(e, t) {
        if (!r(e) || !t) throw new Error(415);
        return wx.setStorageSync(e, JSON.stringify(t))
      },
      fetch(e) {
        if (!r(e)) throw new Error(415);
      ...
      save() {
        ...
        return "h5" === t || "nodejs" === t ? e = new Promise((e, t) => {
          ...
          for (let n of l) a.upload({
            ...
            data: u,
            success: function (n) {
              console.log("handling success" + i);
              var r = n.data;
              i.push(r), i.length === l.length && (l = [], e(i), t(i))
            },
            fail: function (e, t) {
